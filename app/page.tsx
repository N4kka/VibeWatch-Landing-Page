    ...
    <div className="bg-background-light dark:bg-background-dark text-gray-800 dark:text-gray-200 font-sans antialiased overflow-x-hidden selection:bg-primary selection:text-white min-h-screen">
      ...
      <section className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            {/* Left Column - Intro */}
            <motion.div 
              className="lg:col-span-1 flex flex-col items-center lg:items-end text-center lg:text-right space-y-6"
              variants={staggerContainer}
              initial="hidden"
              animate="visible"
            >
              <motion.h1 
                className="text-5xl sm:text-6xl lg:text-7xl font-problem font-extrabold tracking-tight leading-[1.1] text-gray-900 dark:text-white max-w-lg lg:max-w-md"
                variants={fadeInUp}
              >
              ...
              <motion.p 
                className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-lg leading-relaxed font-problem tracking-wide"
                variants={fadeInUp}
              >
                {home.hero.subtitle}
              </motion.p>
            ...
            {/* Right Column - Phone Mockup & Solution Text */}
            <div className="lg:col-span-1 relative flex flex-col items-center lg:items-start text-center lg:text-left space-y-8 mt-16 lg:mt-0">
              ...
              >
                <h2 className="text-5xl sm:text-6xl lg:text-7xl font-solution font-extrabold tracking-tight leading-[1.1] text-gray-900 dark:text-white max-w-lg lg:max-w-md">
                  {home.hero.solutionTitle}
                </h2>
                <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-xl leading-relaxed font-solution mt-4">
                  {home.hero.solutionSubtitle}
                </p>
              </motion.div>
              
              {/* Hero Phone Mockup - Floating Animation */}
              <motion.div 
                className="relative w-[320px] h-[650px] bg-black border-[12px] border-[#1a1a1a] rounded-[3.5rem] shadow-2xl overflow-hidden z-20 ring-1 ring-white/10 group"
                variants={float}
                animate="animate"
              >
      ...
      <section className="py-20 bg-white dark:bg-surface-dark border-y border-gray-100 dark:border-white/5" id="features">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeInUp} className="group p-6 rounded-2xl bg-gray-50 dark:bg-background-dark border border-gray-200 dark:border-white/5 hover:border-primary/50 transition-all duration-300">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div 
              ...
              className="p-8 rounded-2xl bg-white dark:bg-surface-dark border border-red-500/20 shadow-lg relative overflow-hidden"
            >
            ...
            <motion.div 
              ...
              className="p-8 rounded-2xl bg-white dark:bg-surface-dark border border-primary/30 shadow-lg shadow-primary/5 relative overflow-hidden transform md:-translate-y-4"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <motion.div 
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-white dark:bg-surface-dark rounded-3xl p-8 border border-gray-200 dark:border-white/5 shadow-xl"
            >
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
              className="bg-surface-dark rounded-3xl p-8 border border-white/5 relative overflow-hidden flex flex-col justify-center"
            >
      ...
      <section className="py-24" id="pricing">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-surface-dark rounded-[2.5rem] p-8 md:p-16 text-center border border-white/5 relative overflow-hidden"
          >
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto mb-10">
                {/* Free Plan */}
                <motion.div whileHover={{ y: -5 }} className="bg-background-dark/50 backdrop-blur-sm rounded-2xl p-8 border border-white/5 hover:border-white/10 transition-colors text-left flex flex-col h-full">
                  <div className="mb-auto">
                    ...
                    <div className="flex items-baseline gap-1 mb-6">
                      ...
                      {home.cta.plans[0].showCurrency !== false && <span className="text-gray-500 text-sm">USD</span>}
                    </div>
                ...
                {/* Pro Plan */}
                <motion.div whileHover={{ y: -5 }} className="bg-gradient-to-b from-surface-dark-lighter to-background-dark backdrop-blur-sm rounded-2xl p-8 border border-primary/50 shadow-lg shadow-primary/5 text-left flex flex-col h-full relative">
                  ...
                  <div className="mb-auto">
                    <h3 className="text-white font-bold text-xl mb-1 text-primary">{header.foundingChip.split(' ')[0]} Member</h3>
                    <div className="flex items-baseline gap-1 mb-6">
